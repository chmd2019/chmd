...
ob_start ();
$existe = '';
$datos = mysqli_query ($conexion, "select vpp.id,vpp.fecha2,vs.correo,vpp.calle_numero,vpp.colonia,
...
where not vpp.estatus='3'  and vpp.archivado=0 order by vpp.id" );
	...
	<div class="container">
		...
		<div class="masthead">
			...
			<ul class="nav nav-justified">
				<li class="active"><a href="#">Solicitudes de Permenente</a></li>
		...
		<!-- Button trigger modal -->
                ...
                <a href="Alta_permanente.php" style="cursor: pointer;" class="btn btn-primary btn-default pull-right btn-nuevo"><span class="glyphicon glyphicon-plus"></span>
                                            </a>
                
		<h2>Solicitides Permanentes:</h2>
