...
ob_start ();
$existe = '';
$datos = mysqli_query ( $conexion,"select vpv.id,vpv.fecha2,
...
where not vpv.estatus='3' and vpv.archivado=0 order by vpv.id" );
	...
	<div class="container">
		...
		<div class="masthead">
			...
			<ul class="nav nav-justified">
				<li class="active"><a href="#">Solicitudes de Temporal</a></li>
                                <li><a href="PPermanente.php">Solicitudes Permanente</a></li>
