...
ob_start ();
$existe = '';
$datos = mysqli_query ($conexion, "select vpd.id,vpd.fecha2,vs.correo,vpd.calle_numero,vpd.colonia,
...
where not vpd.estatus='3'  and vpd.archivado=0 order by vpd.id" );
	...
	<div class="container" id='principal'>
		...
		<div class="masthead">
			...
			<ul class="nav nav-justified">
				<li class="active"><a href="#">Solicitudes de Diario</a></li>
                                <li><a href="PViaje.php">Solicitudes de Temporal</a></li>
                                <li><a href="PPermanente.php">Solicitud Permenente</a></li>
			</ul>
		</div>
		<br>
