                                ...
                                <div class="col s12 m6 l4">
                                    <div class="card" style="box-shadow: none">
                                        ...
                                        <div class="card-content text-center" style="padding:0px;margin-top: -15px">
                                            ...
                                            <svg class="activator waves-effect waves-light" width="30px" version="1.1"
                                                 id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                                 xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                 viewBox="0 0 600 600" style="enable-background:new 0 0 600 600;"
                                                 xml:space="preserve">
                                                    <style type="text/css">
                                                        .st0 {
                                                            fill: #0E497B;
                                    ...
                                    <div class="card" style="box-shadow: none">
                                        <div class="card-image waves-block efecto-btn">
                                            <a href='https://users.schoolcloud.net/campus/chmd'>
                                                <!-- schoolcloud -->
                                                <img src="images/svg_main_menu/School cloud.svg"
                                    ...
                                    <div class="card" style="box-shadow: none">
                                        <div class="card-image waves-block efecto-btn">
                                            <a href='misarchivos/misarchivos.php'>
                                                <!-- misarchivos -->
                                                <img src="images/svg_main_menu/Mis documentos.svg"
                                                     style="padding:1.5rem;">
                                            </a>
                                        </div>
                                        <div class="card-content text-center" style="padding:0px;margin-top: -15px">
                    ...
                    <div class="col s12 m6 l4">
                        <div class="card" style="box-shadow: none;">
                            ...
                            <div class="card-content text-center" style="padding:0px;margin-top: -15px">
                                ...
                                <svg class="activator waves-effect waves-light" width="30px" version="1.1" id="Layer_1"
                            ...
                            <div class="col s12 m6 l4">
                                <div class="card" style="box-shadow: none">
                                    ...
                                    <div class="card-reveal b-azul white-text">
                                        <span class="card-title white-text">Información adicional<i
                                                    class="material-icons right">close</i></span>
                                        <p>Pedidos de paquete de uniformes incluido en la canasta básica y de uniformes
                                            adicionales.</p>
                                    </div>
                                </div>
                            </div>
