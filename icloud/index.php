...
<header id="header_main">
	<div id="header_inner">
		...
		<h1 id="header_title"><a href="#" id="link"><span id="logo1" class="first-line">COLEGIO HEBREO</span> <span class="second-line" id="logo2">MAGUEN DAVID</span></a></h1>
...
if (isset($authUrl)) {
    ...
    if ($consulta) { //if user already exist change greeting text to "Welcome Back"
        ...
        BootstrapDialog.show({
            title: 'Ayuda',
            message: 'Solicitudes de cambio Permanente, Temporal, Del día.'
        });
        -->
         </div>";
        ...
        BootstrapDialog.show({
            ...
            message: 'podras ver las imagenes de eventos del colegio. '
        });
        -->
         </div>";
        ...
        BootstrapDialog.show({
            title: 'Uniformes',
            message: 'Pedidos de paquete de uniformes incluido en la canasta básica y de uniformes adicionales.'
        });
        -->
         </div>";
        ...
        BootstrapDialog.show({
            title: 'Choferes',
            message: 'Registro y baja de choferes.'
        });
        -->
         </div>";
        ...
        BootstrapDialog.show({
            title: 'Facturas',
            message: 'Historial de facturas y modificación de datos de facturación.'
        });
        -->
         </div>";
        ...
        BootstrapDialog.show({
            ...
            message: 'Podrás realizar su reservación de citas de tus hijos por nivel.'
        });
        -->
         </div>";
  ...
  <tbody>
    <tr>
<td data-label=''>
<a href='menu.php?idseccion=1'><img src='pics/activos/transportes.png' width='150px' height='150px' alt=''></a><br>$Trasportes
</td>

<td data-label=''>
<a href='http://colegium.chmd.edu.mx' target='_blank'><img src='pics/activos/colegi.png' width='150px' height='150px' alt=''></a><br>$Colegium
</td>
<td data-label=''>
<a href='https://users.schoolcloud.net/campus/chmd' target='_blank'><img src='pics/activos/schoolcloud.png' width='150px' height='150px' alt=''></a><br>$Colegium
</td>
    ...
    <tr>
    <td colspan=0> <a href='RFC/RFC.php' ><img src='pics/activos/facturacion.png' width='150px' height='150px'> </a><br>$Facturas</td>    
    <td  colspan=0><a href='https://chmd.edu.mx/galeria/' target='_blank'><img src='https://chmd.edu.mx/wp-content/uploads/2018/07/iconGaleria.png' width='130px' height='130px' alt=''><br><b><font color='#124A7B'  size='3'>GALERIA</font></b></a><br>$Colegium</td>
    <td data-label=''>

 <a href='Uniformes/menu.php' ><img src='pics/inactivos/uniformes.png' width='150px' height='150px'><br><font color='#124A7B'> </a><br>$Uniformes
</td>
    </tr>
            ...
            elseif ($perfil==4) /*****************padre y comite***********************************/
      {
       ...
       $Colegium= "  <div class='source-code runnable'  style='display:none;'>
        ...
        -->
            ...
            $IB= "<div class='source-code runnable'  style='display:none;'>
        <!--
        BootstrapDialog.show({
            title: 'IB',
            message: 'consulta de evaluacion.'
        });
        -->
         </div>";
          $Facturas= "<div class='source-code runnable'  style='display:none;'>
        ...
        -->
                ...
                $eventos= "<div class='source-code runnable'  style='display:none;'>
        <!--
        BootstrapDialog.show({
            title: 'Minuta de eventos',
            message: 'Podrás realizar un evento y generación de minuta del evento.'
        });
        -->
         </div>";
...
<a href='https://users.schoolcloud.net/campus/chmd' target='_blank'><img src='pics/activos/schoolcloud.png' width='150px' height='150px' alt=''></a><br>$Colegium
 ...
 <td data-label=''>
         <a href='RFC/RFC.php' ><img src='pics/activos/facturacion.png' width='160px' height='160px'> </a><br>$Facturas
...
<tr>
<td colspan=1> <a href='Uniformes/menu.php' ><img src='pics/inactivos/uniformes.png' width='150px' height='150px'><br><font color='#124A7B'> </a><br>$Uniformes</td>    
<td  colspan=1><a href='https://chmd.edu.mx/galeria/' target='_blank'><img src='https://chmd.edu.mx/wp-content/uploads/2018/07/iconGaleria.png' width='130px' height='130px' alt=''><br><b><font color='#124A7B'  size='3'>GALERIA</font></b></a><br>$Colegium</td>
<td colspan=2> <a href='Eventos/menu.php' ><img src='pics/activos/eventos.png' width='150px' height='150px'><br><font color='#124A7B'> </a><br>$eventos</td>
...
<center>     
  ...
  <tbody>
      <tr>
         <td><a title="hangouts" href="https://hangouts.google.com/" target="_blank"><img src="pics/hangout.png" alt="chmd" width="120px" height="120px" /></a></td>
	<td><a title="Calendar" href="https://www.google.com/calendar?tab=mc" target="_blank"><img src="pics/calendar.png" alt="chmd" width="120px" height="120px" /></a></td>
	<td><a title="" href="http://classroom.google.com/" target="_blank"><img src="pics/classroom.png" alt="chmd" width="120px" height="120px"/></a></td>
	<td><a title="Los Tejos" href="https://drive.google.com/?tab=mo&authuser=0" target="_blank"><img src="pics/drive.png" alt="chmd" width="120px" height="120px" /></a></td>
	<td><a href="http://search.ebscohost.com/login.aspx?authtype=uid&user=maguen&password=ebsco&group=main " target="_blank"> <img src="pics/ebsco.png" alt="chmd" width="120px" height="120px" /></a></td>
      </tr>
      <tr>
          <td><a title="Los Tejos" href="https://mail.google.com/mail/?tab=mm" target="_blank"><img src="pics/gmail.png" alt="chmd" width="120px" height="120px" /></a></td>
	<td><a title="Los Tejos" href="http://chmd.chmd.edu.mx:61085/login/index.php" target="_blank"><img src="pics/moodle.png" alt="chmd" width="120px" height="120px" /></a></td>
	<td><a title="Los Tejos" href="https://sites.google.com/?tab=m3" target="_blank"><img src="pics/sites.png" alt="chmd" width="120px" height="120px" /></a></td>
	
	<td><a href="http://sn3.colegium.com/es_CL/login/alternativo?id=1583E1CHMD-mx.sha1(YobA6ixTNSO2klMq+1).1" target="_blank"> <img src="pics/colegium.png" alt="chmd" width="120px" height="120px" /></a></td>
        <td><a href="http://esp.brainpop.com/user/loginDo.weml?user=maguen1&password=biblioteca" target="_blank"> <img src="pics/brainpop.png" alt="chmd" width="120px" height="120px" /></a></td>
      </tr>
