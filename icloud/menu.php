...
else 
{
    ...
    if($idseccion==1){$titulo="Cambios de transportes";}
    if($idseccion==5){$titulo="Datos de facturación";}
...
if($idmodulo==2){  $mensaje="<div class='source-code runnable'  style='display:none;'>
        <!--
        BootstrapDialog.show({
            title: 'Temporal',
...
if($idmodulo==3){    $mensaje= "   <div class='source-code runnable'  style='display:none;'>
        <!--
        BootstrapDialog.show({
