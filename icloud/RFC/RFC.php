...
<script src="../js/Alta_Rfc.js" type="text/javascript" charset="utf-8"></script>
...
<header id="header_main">
	<div id="header_inner">
	    ...
	    <ul id="header_links">
	    	<li class="item"><a href="#"><span class="svg-inner"><?xml version="1.0" encoding="utf-8"?>
...
{//esta logueado el correo de gmail
    echo '<h2> <font color="#124A7B">Datos de Facturación</font></h2> <h3> [<a href="'.$redirect_uri.'?logout=1">Logout</a>]<br>&nbsp; &nbsp;&nbsp; &nbsp;</h3>';  
