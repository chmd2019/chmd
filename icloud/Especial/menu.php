            ...
            if ($consulta) {
                if ($cliente = mysqli_fetch_array($consulta)) {
                    ...
                    <div class="col s12 m10 l6">
                        <div class="card" style="box-shadow: none"> 
                            <div class="card-image waves-effect waves-block waves-light">     
                                <a href='Eventos/PEventos.php?idseccion=1<?php //echo "$link?idmodulo=$idmodulo&idseccion=$idseccion";         ?>'>
                                    <img src="https://www.chmd.edu.mx/wp-content/uploads/2018/07/iconMiMaguen.png" style="padding:3rem;">  
                                </a>
                            </div>
                    ...
                    <div class="col s12 m10 l6">
                        <div class="card" style="box-shadow: none"> 
                            <div class="card-image waves-effect waves-block waves-light">     
                                <a href='Especial/PEspecial.php?idseccion=1<?php //echo "$link?idmodulo=$idmodulo&idseccion=$idseccion";         ?>'>
                                    <img src="https://www.chmd.edu.mx/wp-content/uploads/2018/07/iconMiMaguen.png" style="padding:3rem;">  
                                </a>
                            </div>
                            <div class="card-content text-center" style="padding:0px;margin-top: -15px">
