  ...
  if ($consulta = mysqli_fetch_array($consulta)) {
    ...
    <div class="row">
      ...
      -->
        ...
        <h5 class="center-align c-azul">Editar Automóvil</h5>
        ...
        <div class="row" style="padding:0rem .5rem;">
            ...
            <div class="input-field" style="margin:0">
              ...
              <select id="marca<?=$n?>" style="font-size: 1rem"  type="text" >
                ...
                while ($r = mysqli_fetch_array($lista_marca) ){
                  ...
                  $marca_opcion = $r['marca'];

                  ?>

                  <option value="<?=$marca_opcion?>" <?php if ($marca_opcion==$marca) echo 'selected'?> ><?=$marca_opcion?></option>
          ...
          <div class="col s12 l6">
            ...
            <div class="input-field" style="margin:0">
              ...
              <select id="modelo" style="font-size: 1rem"  type="text" >
                <option value="" disabled>Seleccione un A&ntilde;o</option>
                ...
                for ($i  = $max_anio; $i >= $min_anio; $i-- ){
                  ?>
                  <option value="<?=$i?>" <?php if ($i == $modelo ) echo 'selected'; ?>><?=$i?></option>
                  <?php
                }
                ?>
              </select>
            ...
            <div class="input-field" style="margin:0">
              ...
              <select id="color<?=$n?>" style="font-size: 1rem"  type="text" >
                ...
                while ($r = mysqli_fetch_array($lista_color) ){
                  ...
                  $color_opcion = $r['color'];

                  ?>

                  <option value="<?=$color_opcion?>" <?php if ($color_opcion==$color) echo 'selected'?>><?=$color_opcion?></option>
