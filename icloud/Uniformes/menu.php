...
<link rel="stylesheet" href="../shared/main_2_1.css" type="text/css">
...
<link rel="stylesheet" href="../css/alertify.default.css" />
  ...
  <!-------------------------alert----sweet------------------------------------>
<script type="text/javascript" src="js/actualizar_pedido.js"></script>
...
//$perfil=$cliente[2];
 ...
 //echo "<script>jQuery(function(){ swal('Atención!', 'Seccion de cerrada.', 'warning');});</script>";

 
     ?>
      <center><h2> <font color="#124A7B">Pedido Uniformes</font></h2><?php echo '<h3> [<a href="'.$redirect_uri.'?logout=1">Salir</a>]<br>&nbsp; &nbsp;&nbsp; &nbsp;</h3>'; ?><a href='javascript:history.back(1)' title='Regresar'> <img src='../images/atras.png' width='80px' height='80px' alt='$modulo'></a></center>
...
<td data-label=''>
  <!-- <a href='Uniformes.php?idseccion=1'><img src='../pics/activos/uniforme_canasta.png' width='150px' height='150px' alt=''></a>-->
 <a href="javascript:void(0);" onclick="Cerrado();return false;"><img src='../pics/inactivos/uniforme_canasta.png' width='150px' height='150px' alt=''></a> 
</td>
<td data-label=''>
   <!-- <a href='Adicional.php?idseccion=2'><img src='../pics/activos/uniforme_adicional.png' width='150px' height='150px' alt=''></a>-->
    <a href="javascript:void(0);" onclick="Cerrado();return false;"><img src='../pics/inactivos/uniforme_adicional.png' width='150px' height='150px' alt=''></a>
</td>
