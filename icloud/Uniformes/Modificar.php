...
if(isset($_POST['submit'])){
	...
	if ( $objUniforme1->actualizar_pedido(array($talla_sudadera,
                                           $talla_pants,
                                           $talla_playera,
                                           $talla_educacionf,
                                           $talla_kinder,
                                           ...
                                           $tipoplayera,
                                           $tipopants,
                                           $tipoedu),$correo) == false)
                {
		echo 'Pedido Actualizado';
             
	}else
            {
		echo 'Se produjo un error. Intente nuevament';
	} 
}
else
    {
...
{ 
    ...
    var dato = "<?php echo $talla_kinder; ?>" ;
 $("#talla_kinder option[value='<?php echo $talla_kinder; ?>']").attr("selected",true);
...
<?php
		echo "<center>
	<form id='frmClienteActualizar' name='frmClienteActualizar' method='post' action='Modificar.php' onsubmit='actualizar_pedido(); return false'>
...
<th colspan=3> <font color='#FFFFFF' size='3'>Una vez seleccionada la talla y el modelo no habrá cambios.<font></th>
		...
		<input  type='hidden' name='talla_sudadera' id='talla_sudadera' value='no aplica' />
		<input  type='hidden' name='talla_pants' id='talla_pants' value='no aplica' />
		<input  type='hidden' name='talla_playera' id='talla_playera' value='no aplica' />
		<input  type='hidden' name='talla_educacionf' id='talla_educacionf' value='no aplica' />	
...
{ 
    ...
    var dato = "<?php echo $talla_sudadera; ?>" ;
      var dato1 = "<?php echo $talla_pants; ?>" ;
        var dato2 = "<?php echo $talla_playera; ?>" ;
          var dato3 = "<?php echo $talla_educacionf; ?>" ;
          
          
 $("#talla_sudadera option[value='<?php echo $talla_sudadera; ?>']").attr("selected",true);
 $("#talla_pants option[value='<?php echo $talla_pants; ?>']").attr("selected",true);
 $("#talla_playera option[value='<?php echo $talla_playera; ?>']").attr("selected",true);
 $("#talla_educacionf option[value='<?php echo $talla_educacionf; ?>']").attr("selected",true);
...
<tr align='center' valign='middle'> 
		...
		<input  type='hidden' name='nfamilia' id='nfamilia' value='$nfamilia' />
		<input  type='hidden' name='status' id='status' value='1' />	 
		<input  type='hidden' name='talla_kinder' id='talla_kinder' value='no aplica' />	  
		<input  type='hidden' name='idalumno' id='idalumno' value='$idalumno' />
...
{ 
    ...
    var dato = "<?php echo $talla_sudadera; ?>" ;
        ...
        var dato2 = "<?php echo $talla_playera; ?>" ;
           ...
           var dato4 = "<?php echo $tiposudar; ?>" ;
           
           if(dato4=="1")
           {
              
              
               $(".suda").attr('checked', 'checked');
               $('.sudadera').show(); $('.sudadera1').show();  $('.chamarra').hide();  $('.chamarra1').hide(); $('.inicial').hide();  $('.inicial1').hide();
                $("#talla_sudadera1 option[value='<?php echo $talla_sudadera; ?>']").attr("selected",true);
             ...
             if(dato4=="2")
           {
               ...
               $(".chama").attr('checked', 'checked');
               $('.chamarra').show();  $('.sudadera').hide(); $('.inicial').hide(); $('.chamarra1').show();  $('.sudadera1').hide(); $('.inicial1').hide();
                   $("#talla_sudadera2 option[value='<?php echo $talla_sudadera; ?>']").attr("selected",true);
	...
	<form id='frmClienteActualizar' name='frmClienteActualizar' method='post' action='Modificar.php' onsubmit='actualizar_pedido(); return false'>
		...
		<table id='gradient-style' summary='Meeting Results' style='width: 100%;'>
               ...
               <tr>
                ...
                <td colspan=1>
                <label>
  <input type='radio' name='tiposuda' id='tiposuda'  value='1' class='suda'>
<img src='images/sudadera.JPG' width='90' height='90'><img src='images/sudaderap.jpg' width='90' height='90'>
</label>
<BR>SUDADERA</td>
                <td colspan=2>
                        <label>
  <input type='radio' name='tiposuda' id='tiposuda'  value='2'  class='chama'>
  <img src='images/chamarra.jpg' width='90' height='90'>  <img src='images/chamarrap.jpg' width='90' height='90'>
  ...
  <OPTION VALUE='3' selected>Tipo</OPTION>   
		...
		<input  type='hidden' name='nfamilia' id='nfamilia' value='$nfamilia' />	
		<input  type='hidden' name='talla_pants1' id='talla_pants1' value='no aplica' />
                <input  type='hidden' name='talla_pants2' id='talla_pants2' value='no aplica' />
		<input  type='hidden' name='talla_educacionf' id='talla_educacionf' value='no aplica' />	
		<input  type='hidden' name='talla_kinder' id='talla_kinder' value='no aplica' />	
                <input  type='hidden' name='status' id='status' value='1' />			
		<input  type='hidden' name='idalumno' id='idalumno' value='$idalumno' />
        ...
        var dato2 = "<?php echo $talla_playera; ?>" ;
          var dato3 = "<?php echo $talla_educacionf; ?>" ;
           ...
           if(dato4=="1")
           {
               ...
               $('.sudadera').show(); $('.sudadera1').show();  $('.chamarra').hide();  $('.chamarra1').hide(); $('.inicial').hide();  $('.inicial1').hide();
                $("#talla_sudadera1 option[value='<?php echo $talla_sudadera; ?>']").attr("selected",true);
                 $("#talla_pants1 option[value='<?php echo $talla_pants; ?>']").attr("selected",true);
           }
             ...
             if(dato4=="2")
           {
               ...
               $('.chamarra').show();  $('.sudadera').hide(); $('.inicial').hide(); $('.chamarra1').show();  $('.sudadera1').hide(); $('.inicial1').hide();
                   $("#talla_sudadera2 option[value='<?php echo $talla_sudadera; ?>']").attr("selected",true);
                    $("#talla_pants2 option[value='<?php echo $talla_pants; ?>']").attr("selected",true);
           }
