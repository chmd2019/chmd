...
(function(global, factory) {
  ...
  var defaultOptions = {
    ...
    labelIdle: [
      '<i class="material-icons prefix c-azul">cloud_upload</i><br><br><br>Arrastre y suelte o <span class="filepond--label-action">Presione</span> para subir archivos.<span class="col s12"><br><br></span>',
      Type.STRING
    ],
    labelInvalidField: ['Field contains invalid files', Type.STRING],
    labelFileWaitingForSize: ['Waiting for size', Type.STRING],
    labelFileSizeNotAvailable: ['Tamaño no permitido', Type.STRING],
    ...
    labelFileProcessingError: ['Error al cargar archivo', Type.STRING],
    labelFileProcessingRevertError: ['Error during revert', Type.STRING],

    labelTapToCancel: ['Cancelar', Type.STRING],
    labelTapToRetry: ['Intentar nuevamente', Type.STRING],
    labelTapToUndo: ['Deshacer', Type.STRING],
