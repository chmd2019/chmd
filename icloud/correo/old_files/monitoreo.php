...
$consulta=$objCliente->permanente();
...
while($cliente=mysql_fetch_array($consulta))
                {
                     ...
                     $correo=$cliente[1];
                     $estatus=$cliente[2];
                     $notificacion1=$cliente[3];
                     $notificacion2=$cliente[4];
                     $notificacion3=$cliente[5];
                     $mensaje=$cliente[6];
