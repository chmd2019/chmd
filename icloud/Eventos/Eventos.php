...
$consulta1=$objComite->mostrar_comite($dato);
  
 if( $cliente1 = mysql_fetch_array($consulta1) )
{
$id_comite=$cliente1[0];
$comite=$cliente1[1];
     if($id_comite==3)
         {
            echo   "<a  href='menu_1.php'><img src='../pics/activos/comites/555.png' width='50' height='50'/></a>";
         }
}

////////////////////////validacion de permisos/////////////////////////////

$objPermisos=new Ctr_minuta();
$consulta11=$objPermisos->AccesoPermisos($correo2,$_GET['idseccion']);
$cliente11 = mysql_fetch_array($consulta11); 
$perfil11=$cliente11[5];

 $_SESSION['perfil'] = $perfil11;
////////////////////////////////////////////////////

            echo '<h2> <font color="#124A7B">Comité:'.$comite.'</font></h2> ';  
  //    
            
            
      
            include ("View_evento.php");
