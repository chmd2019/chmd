...
<link rel="stylesheet" href="../shared/main_2.css" type="text/css">
...
{
     ?>
      <center><h2> <font color="#124A7B">Órganos de Gobierno</font></h2><?php echo '<h3> [<a href="'.$redirect_uri.'?logout=1">Salir</a>]<br>&nbsp; &nbsp;&nbsp; &nbsp;</h3>'; ?><a href='javascript:history.back(1)' title='Regresar'> <img src='../images/atras.png' width='80px' height='80px' alt='$modulo'></a><br>&nbsp;</center>
                    

     
    <table id='respon' border='1'>
  <tbody>
    <tr>
<td data-label=''>
<a href='Eventos.php?idseccion=1'><img src='../pics/activos/comites/1.png' width='150px' height='150px' alt=''></a>
</td>
<td data-label=''>
<a href='Eventos.php?idseccion=2'><img src='../pics/activos/comites/2.png' width='150px' height='150px' alt=''></a>
</td>
...
-->
    ...
    <tr>
        <td data-label=''>
            <a href='menu_comites.php'><img src='../pics/activos/comites/comite.png' width='150px' height='130px' alt=''></a>
</td>
<td data-label=''>
    <a href='menu_comision.php'><img src='../pics/activos/comites/comision.fw.png' width='150px' height='130px' alt=''></a>
</td>
    </tr>
  ...
  <tbody>
    <tr>
        <?php
         ...
         $objCliente11=new Login();
          $consulta11=$objCliente11->AccesoEventos($correo);
           while( $cliente11 = mysql_fetch_array($consulta11) )
              
{
                
$id11=$cliente11[0];
$correo211=$cliente11[1];
$estatus11=$cliente11[2];
$nombre11=$cliente11[3];
$comite11=$cliente11[4];
$perfil11=$cliente11[5];

echo "<td data-label=''>
        <a href='Eventos.php?idseccion=$comite11'><img src='../pics/activos/comites/$comite11.png' width='150px' height='150px' alt=''></a>
      </td> ";
