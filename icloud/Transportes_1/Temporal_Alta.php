    ...
    if (isset($_POST['submit'])) {
        ...
        if ($objCliente->Temporal_Alta(array(
                ...
                $modal->redirigir_pagina("./PTemporal.php");*/
                    echo "<script>alertify.alert('Solicitud guardada', function(){});</script>";
        } else {
                                    ...
                                    <tr id="fila-<?php echo $cliente['id'] ?>">
                                        ...
                                        <td>  <label><center><input type="checkbox" id="alumno<?php echo $counter ?>" name="alumno[]" value="<?php echo $cliente1[id]; ?> " required></center>  <label></td> 
                                            ...
                                            <p>
                                                ...
                                                <input class="w3-input" id="campo_celular" onblur="validarCelular()" name="celular" type="number"  id="celular"  pattern="[0-9]{10}" placeholder="Agrega 10 u 8 digitos  " required /> 
                                            </p>
                                            <p>
