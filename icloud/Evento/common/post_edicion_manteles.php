...
$control->edicion_manteles_eliminar($id_montaje, $id_mantel);

for ($index = 1; $index <= $cantidad; $index++) {
    $res = $control->edicion_manteles($id_mantel, $id_montaje, $fecha_montaje_simple, $hora_inicial, $hora_final, 
        $hora_min, $hora_max);
}
