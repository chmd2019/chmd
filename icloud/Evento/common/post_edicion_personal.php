...
$control->edicion_personal_eliminar($id_montaje, $id_personal);

for ($index = 1; $index <= $cantidad; $index++) {
    $res = $control->edicion_personal($id_personal, $id_montaje, $fecha_montaje_simple, $hora_inicial, $hora_final, 
