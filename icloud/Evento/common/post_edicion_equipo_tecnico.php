...
$control->edicion_equipo_tecnico_eliminar($id_montaje, $id_articulo);

for ($index = 1; $index <= $cantidad; $index++) {
    $res = $control->edicion_equipo_tecnico($id_articulo, $id_montaje, $fecha_montaje_simple, $hora_inicial, $hora_final, 
        $hora_min, $hora_max);
}
