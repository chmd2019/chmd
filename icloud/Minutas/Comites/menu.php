...
if (isset($authUrl)) :
    ...
    <div>
        ...
        <br>
        <h4 class="col s12 c-azul text-center">Comités</h4> 
        <div class="row">
            <div class="col s12 m8" style="float:none;margin:auto">       
                    ...
                    <div class="card" style="box-shadow: none">
                        <div class="card-image waves-block efecto-btn">
                            <a href='Eventos/Eventos.php?idseccion=1'>
                                <img src="../../pics/activos/comites/3.png" style="padding:3rem;">
                            </a>
                        </div>
                ...
                <div class="col s12 m10 l4">
                    <div class="card" style="box-shadow: none">
                        <div class="card-image waves-block efecto-btn">
                            <a href='Eventos/Eventos.php?idseccion=1'>
                                <img src="../../pics/activos/comites/5.png" style="padding:3rem;">
                            </a>
                        </div>
                        <div class="card-content text-center" style="padding:0px;margin-top: -30px">
                            <img class="activator waves-effect waves-light" src="../../../icloud/images/Info.svg" style="width: 30px;"/>
                ...
                <div class="col s12 m10 l4">
                    <div class="card" style="box-shadow: none">
                        <div class="card-image waves-block efecto-btn">
                            <a href='Eventos/Eventos.php?idseccion=1'>
                                <img src="../../pics/activos/comites/10.png" style="padding:3rem;">
                            </a>
                        </div>
                        <div class="card-content text-center" style="padding:0px;margin-top: -30px">
                            <img class="activator waves-effect waves-light" src="../../../icloud/images/Info.svg" style="width: 30px;"/>
                ...
                <div class="col s12 m10 l4">
                    <div class="card" style="box-shadow: none">
                        <div class="card-image waves-block efecto-btn">
                            <a href='Eventos/Eventos.php?idseccion=1'>
                                <img src="../../pics/activos/comites/9.png" style="padding:3rem;">
                            </a>
                        </div>
                        <div class="card-content text-center" style="padding:0px;margin-top: -30px">
                            <img class="activator waves-effect waves-light" src="../../../icloud/images/Info.svg" style="width: 30px;"/>
                ...
                <div class="col s12 m10 l4">
                    <div class="card" style="box-shadow: none">
                        <div class="card-image waves-block efecto-btn">
                            <a href='Eventos/Eventos.php?idseccion=1'>
                                <img src="../../pics/activos/comites/6.png" style="padding:3rem;">
                            </a>
                        </div>
                        <div class="card-content text-center" style="padding:0px;margin-top: -30px">
                            <img class="activator waves-effect waves-light" src="../../../icloud/images/Info.svg" style="width: 30px;"/>
                ...
                <div class="col s12 m10 l4">
                    <div class="card" style="box-shadow: none">
                        <div class="card-image waves-block efecto-btn">
                            <a href='Eventos/Eventos.php?idseccion=1'>
                                <img src="../../pics/activos/comites/4.png" style="padding:3rem;">
                            </a>
                        </div>
                        <div class="card-content text-center" style="padding:0px;margin-top: -30px">
                            <img class="activator waves-effect waves-light" src="../../../icloud/images/Info.svg" style="width: 30px;"/>
