...
if (isset($authUrl)) :
    ...
    <div>
        ...
        <br>
        <h4 class="col s12 c-azul text-center">Órganos de Gobierno</h4> 
        <div class="row">
            <div class="col s12 m5" style="float:none;margin:auto">       
                <div class="col s12 m10 l6">
                    <div class="card" style="box-shadow: none">
                        <div class="card-image waves-block efecto-btn">
                            <a href='Eventos/Eventos.php?idseccion=1'>
                                <img src="../pics/activos/comites/1.png" style="padding:3rem;">
                            </a>
                        </div>
                ...
                <div class="col s12 m10 l6">
                    <div class="card" style="box-shadow: none">
                        <div class="card-image waves-block efecto-btn">
                            <a href='Eventos/Eventos.php?idseccion=2'>
                                <img src="../pics/activos/comites/2.png" style="padding:3rem;">
                            </a>
                        </div>
                        <div class="card-content text-center" style="padding:0px;margin-top: -30px">
                            <img class="activator waves-effect waves-light" src="../../icloud/images/Info.svg" style="width: 30px;"/>
                ...
                <div class="col s12 m10 l6">
                    <div class="card" style="box-shadow: none">
                        <div class="card-image waves-block efecto-btn">
                            <a href='Comites/menu.php'>
                                <img src="../pics/activos/comites/comite.png" style="padding:3rem;">
                            </a>
                        </div>
                        <div class="card-content text-center" style="padding:0px;margin-top: -30px">
                            <img class="activator waves-effect waves-light" src="../../icloud/images/Info.svg" style="width: 30px;"/>
                ...
                <div class="col s12 m10 l6">
                    <div class="card" style="box-shadow: none">
                        <div class="card-image waves-block efecto-btn">
                            <a href='Comisiones/menu.php'>
                                <img src="../pics/activos/comites/comision.fw.png" style="padding:3rem;">
                            </a>
                        </div>
                        <div class="card-content text-center" style="padding:0px;margin-top: -30px">
                            <img class="activator waves-effect waves-light" src="../../icloud/images/Info.svg" style="width: 30px;"/>
