...
<input type="image" src="../pics/calendario.fw.png" width="50" height="50" onclick="mostrar()"> 
</div>
...
$consulta1=$objCliente->mostrar_alumnos($fam);
		  ...
		  <tr id="fila-<?php echo $cliente['id'] ?>">
			  ...
			  <!--<td bgcolor="#ffffff"><?php echo $cliente1['grado'] ?></td>-->
                          <td>  <label><center><input type="checkbox" id="alumno<?php echo $counter?>" name="alumno[]" value="<?php echo $cliente1[id]; ?> " required="required" title="Selecciona un alumno"></center>  <label></td> 
