...
<html lang="en" class="desktop">
    ...
    <head>
        ...
        <script src="../js/Alta_Viaje.js" type="text/javascript" charset="utf-8"></script>
...
////////////// fin agregar diseño////////////////////////////////
            ...
            if (isset($authUrl)) {
                ...
                echo '<h2> <font color="#124A7B">Cambio temporal</font></h2> <h3> [ <a href="' . $redirect_uri . '?logout=1">Salir</a>]<br>&nbsp; &nbsp;&nbsp; &nbsp;</h3>';
                ?>
        ...
        <nav id="mobile_nav">
            ...
            <a href="/"><?php echo "<?xml version='1.0' encoding='utf-8'?>"; ?></a>
...
<script>
    ...
    function validarCelular() {
        if ($('#campo_celular').val().length == 8 || $('#campo_celular').val().length == 10)
        {
            return;
        } else {
            $('#campo_celular').focus();
