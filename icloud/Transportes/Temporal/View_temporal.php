                ...
                while ($permiso = mysqli_fetch_array($listado_permiso_temporal)) {
                    ...
                    if ($solicitud_vencida) {
                        ...
                        <tr style="cursor:pointer;">
                            ...
                            <td>
                              <!--
                              <span class="<?php echo $badge; ?>"><?php echo $status_detalle; ?></span>
                              -->
                            ...
                            <td>
                                        <a class="waves-effect waves-light"
                                           ...
                                           <i class="material-icons">pageview</i>
                                            ...
                                            <style type="text/css">
                                              .stj0{fill:#4FA3D7;}
                                              .stj1{fill:#0E497B;stroke:#0E497B;stroke-miterlimit:10;}
                                              .stj2{fill:#FFFFFF;}
                                            </style>
                                            <circle class="stj0" cx="300" cy="257.69" r="246.41"/>
                                            <g>
                                              <path class="stj1" d="M251,580.94l-17.27-40.61c-0.28-0.63-0.49-1.27-0.49-2.04c0-2.33,1.9-4.23,4.37-4.23
                                              ...
                                              <path class="stj1" d="M284.84,579.39v-40.61c0-2.47,1.9-4.37,4.37-4.37h28.69c2.12,0,3.88,1.76,3.88,3.88
                                              ...
                                              <path class="stj1" d="M328.55,538.78c0-2.47,1.9-4.37,4.37-4.37h17.62c6.2,0,11.07,1.83,14.24,4.93c2.61,2.68,4.09,6.34,4.09,10.64
                                            ...
                                            <g>
                                              <path class="stj2" d="M346.35,83.58c-31.36,0-62.71,11.94-86.59,35.81c-45.68,45.68-47.65,118.76-5.92,166.81l-14.59,14.59
