...
if ($respuesta) {
    echo '<div class="modal fade" id="modal_confirmacion_exitosa" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    echo "<script>$('#modal_confirmacion_exitosa').modal({show:true})</script>";
}
header("Refresh:3; URL = ./PTemporal.php");
?>
