...
<!-------------------------alert----sweet------------------------------------>
<script type="text/javascript" src="js/Pedido_Adicional.js"></script>
<script type="text/javascript" src="js/Terminar_pedido.js"></script>
   <!-- Bootstrap -->
...
////////////////////////////////////////////////////
            ...
            echo '<h2> <font color="#124A7B">Pedido adicional</font></h2> ';  
  //    
            
            
    
            include ("View_Adicional.php");
