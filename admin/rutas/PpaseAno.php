...
<head>
  ...
  <title>CHMD :: Rutas Pase de Año</title>
    ...
    <nav class="" id="sidebar">
      <div id="dismiss">
        ...
        <div class="sidebar-header">
          ...
          <?php $perfil_actual='55'; include ('../menus_dinamicos/perfiles_dinamicos_rutas.php'); ?>
        </nav>
    <!-- Page Content  -->
    <div id="content">
...
<a href="nuevo_pase_ano.php" style="cursor: pointer; margin:2px" class="pull-right"><svg width="120px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          ...
          <button type="button" style="cursor: pointer; margin:5px;outline: none" class="btn btn-primary btn-default pull-right" onclick="pasar_ano()">
            <b><span class="glyphicon glyphicon-repeat"></span>&nbsp;&nbsp;PASO DE AÑO</b>
          </button>
          <!-- Boton de Atras -->
...
<h2 class="text-primary">Listado de Pase de Año</h2>
...
<script type="text/javascript" src="../dist/js/bootstrap.js"></script>
  <script type="text/javascript" src="js/PpaseAno.js"></script>
