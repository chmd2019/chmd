      ...
      if (isset($_POST['alumnos_m'])){
        ...
        foreach ($alumnos_m as $key => $alumno) {
            ...
            if ($existe>0){
              ...
              $sql = "UPDATE rutas_base_alumnos SET id_ruta_base_m='".$alumno['id_ruta']."' , domicilio_m='".$alumno['domicilio']."' , hora_manana ='".$alumno['hora_manana']."' , orden_in = '".$alumno['orden_in'] ."' WHERE id_alumno='".$alumno['id_alumno']."'";
            }else{
              //no existe - insertar alumno
              $sql = "INSERT INTO rutas_base_alumnos( id_alumno, id_ruta_base_m, domicilio_m, hora_manana,
