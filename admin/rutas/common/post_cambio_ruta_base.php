...
if (isset($_POST["summit"])){
  ...
  if ($conexion)
  {
    ...
    if ($turno=='m'){
    $sql_update = "UPDATE rutas_base_alumnos SET id_ruta_base_m='$id_ruta', orden_in='$orden'  WHERE id_alumno='$id_alumno'" ;
    }else if ($turno =='t'){
    $sql_update = "UPDATE rutas_base_alumnos SET id_ruta_base_t='$id_ruta', orden_out='$orden'  WHERE id_alumno='$id_alumno'" ;
    }else{
    $sql_update = "COMMIT" ;
      $error=true;
