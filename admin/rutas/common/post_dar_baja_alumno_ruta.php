...
if (isset($_POST["summit"])){
  ...
  if ($conexion)
  {
    ...
    if ($turno=='m'){
    $sql_update = "UPDATE rutas_base_alumnos SET id_ruta_base_m='0', domicilio_m='', hora_manana='',orden_in='' WHERE id_alumno='$id_alumno'" ;
    }else if ($turno =='t'){
    $sql_update = "UPDATE rutas_base_alumnos SET id_ruta_base_t='0', domicilio_t='', hora_lu_ju='', hora_vie='', orden_out=''  WHERE id_alumno='$id_alumno'" ;
    }else{
    $sql_update = "COMMIT" ;
      $error=true;
