...
*/
      ...
      .ajax({
        ...
        {
          redirect_ver_ruta($(this).attr('data-id'));
        });
        ...
        function redirect_ver_ruta(qwert)
        {
          var url = '../rutas/control_pase_ano.php';
...
function pasar_ano(){
  //remover de la lista de alumnos
  $.ajax({
        url: 'common/post_migrar_rutas_nuevo_ano.php',
        type : 'POST',
        data : {
          migracion : 1
        },
       ...
       //   alert(res);
        ...
        //alert(data.estatus + 'Pendentes: ' + data.pendientes);
          if (data.estatus == true) {
              //colocar una x del lado der
              alert('El Paso de las rutas del Nuevo Año escolar, Ha ocurrido exitosamente!');
              location.reload();
            } else {
              alert('Ha ocurrido un error, Vuelva a intentarlo.');
            }
