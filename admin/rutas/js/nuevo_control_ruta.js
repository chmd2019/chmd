...
var ruta_selected = $("#ruta_selected :checked").val();
if (ruta_selected==='0' || ruta_selected ==='') {
...
if ($(".enlistado").length){
  ...
  var cantidad_alumnos_m = 0;
  var cantidad_alumnos_t = 0;
  //mañana
  $(".id_selected_m").each(
    function(){
      ids_m += $(this).text() + ',';
  ...
  $(".id_selected_t").each(
    ...
    var cupos_disponibles_actual = $("#cupos_actual").val();
    if (cupos_disponibles_actual < cantidad_alumnos_m  || cupos_disponibles_actual < cantidad_alumnos_t) {
      alert("El limite de cupos disponibles en la ruta fué superado!");
      return;
    }
}else{
  //no hay alumno
