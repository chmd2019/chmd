...
$datos = mysqli_query ( $conexion,"SELECT vpa.id as idpermisoalumno, vpa.id_alumno,ac.idcursar, ac.nombre, vp.id_permiso,vp.fecha_creacion,
  ...
  where vpa.estatus=2 and vp.tipo_permiso='5' and LOCATE('$year',vp.fecha_cambio )>0  and LOCATE( '$dia', vp.fecha_cambio )>0 and LOCATE( '$mes_letras', vp.fecha_cambio )>0 order by vpa.estatus_seguridad" );
?>
<!DOCTYPE html>
<html lang="en">
<head>
   ...
   <div class="wrapper">
    ...
    <nav class="" id="sidebar">
      <div id="dismiss">
        ...
        <?php $perfil_actual='21'; include ('../menus_dinamicos/perfiles_dinamicos_seguridad.php'); ?>
...
<h2 class="text-center text-primary">Seguridad de Eventos</h2>
