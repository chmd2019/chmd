...
echo 'Solicitud Guardada';
  ...
  <?php include '../components/header.php'; ?>
    ...
    <a href="PextraordinarioPrimaria.php" style="cursor: pointer;" class="pull-right">
  <!-- Boton de Atras -->
  <?php include 'componentes/btn_atras.php'; ?>
    ...
    if (!$_GET)
    {
        ...
        <form id="diario"  name="diario" class="form-signin save-nivel" method='post'   onsubmit='Alta_diario(); return false'>
          ...
          <div class="modal-body">
            ...
            <table  class="table"  WIDTH="100%" >
              ...
              <?php
              $counter=-1;
              $existe = mysqli_query ($conexion, "SELECT * FROM alumnoschmd where idfamilia=$familia and id_nivel='2'" );
              while($alumno=mysqli_fetch_array($existe))
              {
                ...
                <tr class="horas" id='horas_<?=$counter?>' style = "display:none">
                  <td WIDTH="50%" colspan="5" >Hora de Salida:
                      <div class="input-group date " style="border-top: none !important;">
      ...
      ?>
      <p class="text-danger text-center">No se ha encontrado familia con el número insertado, <a class="text-info" href="alta_extraordinarioPrimaria.php">Volver</a>.</p>
      <?php
      }
      ?>
      <?php
