...
echo 'Solicitud Guardada';
  ...
  <?php include '../components/header.php'; ?>
    ...
    <!-- Button trigger modal -->
      <a href="PextraordinarioBachillerato.php" style="cursor: pointer;" class="pull-right">
  <!-- Boton de Atras -->
  <?php include 'componentes/btn_atras.php'; ?>
    ...
    if (!$_GET)
    {
      ...
      ?>
      <p class="text-danger text-center">No se ha encontrado familia con el número insertado, <a class="text-info" href="alta_extraordinarioBachillerato.php">Volver</a>.</p>
      <?php
      }
      ?>
      <?php
