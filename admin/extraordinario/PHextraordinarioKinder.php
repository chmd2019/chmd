...
<hr>
<?php $perfil_actual='Historial de Kinder';
      include ("componentes/perfiles_dinamicos.php");
 ?>
</div>
<br>
...
<h2>Historial de Solicitides Extraordinarias de Kinder</h2>
...
<!-- Bootstrap core JavaScript
  ...
  <script type="text/javascript" src="js/PHextraordinarioKinder.js"></script>
