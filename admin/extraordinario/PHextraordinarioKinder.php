...
if (!in_array('6', $capacidades)){
    header('Location: PHextraordinarioPrimaria.php');
}
...
<body>
    ...
    <nav class="" id="sidebar">
      <div id="dismiss">
        ...
        <?php $perfil_actual='15'; include ('../menus_dinamicos/perfiles_dinamicos_extraordinarios.php'); ?>
...
<h2 class="text-primary">Historial de Extraordinarios Kinder</h2>
