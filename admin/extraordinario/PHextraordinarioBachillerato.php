...
$datos = mysqli_query ( $conexion,"SELECT vpa.id as idpemisoalumno, vpa.id_alumno, ac.nombre, vp.id_permiso,vp.fecha_creacion,
  ...
  where vpa.estatus>1 and vp.tipo_permiso='4' and ac.id_nivel='3' order by vp.fecha_respuesta DESC " );
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <nav class="" id="sidebar">
      <div id="dismiss">
        ...
        <div class="sidebar-header">
          ...
          <?php $perfil_actual='17'; include ('../menus_dinamicos/perfiles_dinamicos_extraordinarios.php'); ?>
...
<h2 class="text-primary">Historial de Extraordinarios Bachillerato</h2>
