...
$datos = mysqli_query ( $conexion,"SELECT vpa.id as idpemisoalumno, vpa.id_alumno, ac.nombre, vp.id_permiso,vp.fecha_creacion,
  ...
  where vpa.estatus>1 and vp.tipo_permiso='4' and ac.id_nivel='1' order by vp.fecha_respuesta DESC " );
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <nav class="" id="sidebar">
      <div id="dismiss">
        ...
        <?php $perfil_actual='Historial de Extraordinario por Area'; include ('../menus_dinamicos/perfiles_dinamicos_extraordinarios.php'); ?>
...
<?php include 'componentes/nuevos_permisos.php'; ?>
<a href="../menu.php" style="cursor: pointer;margin: 2px" class="pull-right">
  <!-- Boton de Atras -->
  <?php include 'componentes/btn_atras.php'; ?>
</a>
<h2 class="text-primary">Solicitudes de Extraordinarios Area</h2>
