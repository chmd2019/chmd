  ...
  .submit(
    function(e) {
      ...
      .done(
        ...
        function editarNivel(qwert,idpermiso,nfamilia,fecha,correo, nombre, grado, grupo, nivel,estatus , fechap, regresa, hora_salida,  hora_regreso, motivo, mensaje, responsable, parentesco, fecha_cambio, frespuesta)
        {
