      ...
      <div id="dismiss">
        ...
        <div class="sidebar-header">
            <h3>EVENTOS</h3>
                ...
                <?php $perfil_actual='19'; include ('../menus_dinamicos/perfiles_dinamicos_eventos.php'); ?>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/malihu-custom-scrollbar-plugin/3.1.5/jquery.mCustomScrollbar.concat.min.js"></script>
  <script type="text/javascript" src="js/PHeventos.js"></script>
