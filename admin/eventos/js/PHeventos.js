  ...
  .submit(
    function(e) {
      ...
      .done(
        ...
        function editarNivel(qwert,nfamilia,fecha,correo,estatus, codigo, familia, fecha_evento, tipo_evento, empresa,  motivo, mensaje, responsable, parentesco, fecha_cambio, frespuesta)
        {
