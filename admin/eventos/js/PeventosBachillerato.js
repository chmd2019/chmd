  ...
  .submit(
    function(e) {
      ...
      .ajax({
        ...
        function editarNivel(qwert,nfamilia,fecha,correo, codigo, familia, fecha_evento, tipo_evento, empresa,  motivo, mensaje, responsable, parentesco, fecha_cambio, frespuesta)
        {
