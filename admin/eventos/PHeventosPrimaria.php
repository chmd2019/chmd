...
$datos = mysqli_query ( $conexion,"SELECT  vp.id_permiso,vp.fecha_creacion,
  ...
  where  vp.tipo_permiso='5'  order by vp.fecha_respuesta DESC " );
?>
<!DOCTYPE html>
<html lang="en">
<head>
      ...
      <div id="dismiss">
        ...
        <div class="sidebar-header">
            <h3>EVENTOS</h3>
                ...
                <?php $perfil_actual='27'; include ('../menus_dinamicos/perfiles_dinamicos_eventos.php'); ?>
    </nav>
...
<input id="nivel_perfil" type="text"  name="" value="<?=$id_nivel?>" hidden>
</div>
<br>
...
<h2 class="text-primary">Historial de Eventos</h2>
  ...
  <tbody class="searchable" style="overflow: auto; max-height: 500px;">
    <?php while ( $dato = mysqli_fetch_assoc ( $datos ) )
    {
      ...
      //  $id_nivel='2';
        ...
        ?>
        <tr  class="fila_alumnos" id="fila_<?=$id_permiso?>"  style="border-bottom:  1px solid #fff;display:  none;"  data-row="<?php echo $dato['id_permiso']?>" >
        ...
        data-nivelpermiso="<?php echo $id_nivel?>"
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/malihu-custom-scrollbar-plugin/3.1.5/jquery.mCustomScrollbar.concat.min.js"></script>s
  <script type="text/javascript" src="js/PHeventosArea.js"></script>
