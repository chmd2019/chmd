      ...
      <div id="dismiss">
        ...
        <div class="sidebar-header">
            <h3>EVENTOS</h3>
                ...
                <?php $perfil_actual='24'; include ('../menus_dinamicos/perfiles_dinamicos_eventos.php'); ?>
...
<input id="nivel_perfil" type="text"  name="" value="2" hidden>
</div>
<br>
...
<table class="table" id="niveles_table">
  ...
  if ($show){
    ...
    ?>
    <tr class="fila_alumnos" id="fila_<?=$id_permiso?>"  style="display:  none; border-bottom:  1px solid #eee"  data-row="<?php echo $dato['id_permiso']?>">
