      ...
      <div id="dismiss">
        ...
        <div class="sidebar-header">
            <h3>EVENTOS</h3>
                ...
                <?php $perfil_actual='28'; include ('../menus_dinamicos/perfiles_dinamicos_eventos.php'); ?>
...
<input id="nivel_perfil" type="text"  name="" value="3" hidden>
</div>
<br>
