            ...
            <div class="row" style="margin-top:60px">
                ...
                if (in_array('1', $capacidades)) {
                    ...
                    <div class="col-lg-6" style="margin-bottom:30px">
                        <center>
                            <a href="transportes/PDiario.php">
                                <button style="width:100%;height:150px;font-size: xx-large;border-radius: 10px;"
                                        class="btn btn-large btn-primary" type="button">Transportes
                                </button>
                            </a>
                        </center>
                    </div>
                    ...
                    <div class="col-lg-6 justify-self-center" style="margin-bottom:30px">
                        <center>
                            <a href="transportes/choferes/PChoferes.php">
                                <button style="width:100%;height:150px;font-size: xx-large; border-radius: 10px;"
                                        class="btn btn-large btn-primary" type="button">Choferes
                                </button>
                            </a>
                        </center>
                    </div>
                    ...
                    <div class="col-lg-6 justify-self-center" style="margin-bottom:30px">
                        <center>
                            <a href="extraordinario/PextraordinarioKinder.php">
                                <button style="width:100%;height:150px;font-size: xx-large; border-radius: 10px;"
                                        class="btn btn-large btn-primary" type="button">Extraordinario
                                </button>
                            </a>
                        </center>
                    </div>
                    ...
                    <div class="col-lg-6 justify-self-center" style="margin-bottom:30px">
                        <center>
                            <a href="eventos/Peventos.php">
                                <button style="width:100%;height:150px;font-size: xx-large; border-radius: 10px;"
                                        class="btn btn-large btn-primary" type="button">Eventos
                                </button>
                            </a>
                        </center>
                    </div>
                    ...
                    <div class="col-lg-6 justify-self-center" style="margin-bottom:30px">
                        <center>
                            <a href="eventosInternos/PeventosInternosKin.php">
                                <button style="width:100%;height:150px;font-size: xx-large; border-radius: 10px;"
                                        class="btn btn-large btn-primary" type="button">Internos
                                </button>
                            </a>
                        </center>
                    </div>
                    ...
                    <div class="col-lg-6 justify-self-center" style="margin-bottom:30px">
                        <center>
                            <a href="seguridad/menu_seguridad.php">
                                <button style="width:100%;height:150px;font-size: xx-large; border-radius: 10px;"
                                        class="btn btn-large btn-primary" type="button">Seguridad
                                </button>
                            </a>
                        </center>
                    </div>
                    ...
                    <div class="col-lg-6 justify-self-center" style="margin-bottom:30px">
                        <center>
                            <a href="emergencias/Pemergencia.php">
                                <button style="width:100%;height:150px;font-size: xx-large; border-radius: 10px;"
                                        class="btn btn-large btn-primary" type="button">Emergencias
                                </button>
                            </a>
                        </center>
                    </div>
                ...
                if (in_array('31', $capacidades)) {
                    ...
                    <div class="col-lg-6 justify-self-center" style="margin-bottom:30px">
                        <center>
                            <a href="app/PPadres.php">
                                <button style="width:100%;height:150px;font-size: xx-large; border-radius: 10px;"
                                        class="btn btn-large btn-primary" type="button">App
                                </button>
                            </a>
                        </center>
                    </div>
                    <div class="col-lg-6 justify-self-center" style="margin-bottom:30px">
                        <center>
                            <a href="url/urls.php">
                                <button style="width:100%;height:150px;font-size: xx-large; border-radius: 10px;"
                                        class="btn btn-large btn-primary" type="button">Url's
                                </button>
                            </a>
                        </center>
                    </div>
                    <div class="col-lg-6 justify-self-center" style="margin-bottom:30px">
                        <center>
                            <a href="usuariosymodulos/perfiles/perfiles.php">
                                <button style="width:100%;height:150px;font-size: xx-large; border-radius: 10px;"
                                        class="btn btn-large btn-primary" type="button">Usuarios, modulos y perfiles
                                </button>
                            </a>
                        </center>
                    </div>
                    ...
                    <div class="col-lg-6 justify-self-center" style="margin-bottom:30px">
                        <center>
                            <a href="rutas/Prutas_diaria.php">
                                <button style="width:100%;height:150px;font-size: xx-large; border-radius: 10px;"
                                        class="btn btn-large btn-primary" type="button">Rutas
                                </button>
                            </a>
                        </center>
                    </div>
