...
$id = $_GET["id"];
$sql = "SELECT * from App_grupos_especiales WHERE id=$id";
...
<h2 class="text-primary">Modificar grupo especial</h2>

<div class="table-responsive">
<center>
<form method="POST" action="common/actualizarGrupoEspecial.php">
