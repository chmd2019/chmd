...
<h2 class="text-primary">Ingreso de grupos administrativos</h2>

<div class="table-responsive">
<center>
<form method="POST" action="common/nuevoGrupoAdmin.php">
...
<td><input name="grupo" id="grupo"></td>
</tr>

<tr>
<td>Descripcion del grupo</td>
<td><input name="descrip" id="descrip"></td>
</tr>
<tr>
<td colspan="2"><input type="submit" class="btn btn-info" value="Guardar"></td>
</tr>
</table>
