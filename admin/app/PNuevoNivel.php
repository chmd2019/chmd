...
<h2 class="text-primary">Ingreso de niveles</h2>

<div class="table-responsive">
<center>
<form method="POST" action="common/nuevoNivel.php">
...
<tr>
<td>Nombre de nivel</td>
<td><input name="nivel" id="nivel" placeholder="Nombre del nivel"></td>
</tr>
<tr>
