...
<html lang="es">
    <head>
        ...
        <!-- jQuery Custom Scroller CDN -->  <script type="text/javascript" src="js/Ppadres.js"></script>
        ...
        <div class="wrapper">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h2 class="text-primary">Grupos Especiales</h2>
                            ...
                            <tbody class="searchable" style="overflow: auto; max-height: 500px;">
                                ...
                                while ($dato = mysqli_fetch_assoc($datos)):
                                    ...
                                    <tr style="background:<?= $color ?>; border-bottom: 1px solid <?= $borde ?>"  data-row="<?php //echo $dato['id_permiso']           ?>">
                                        ...
                                        <td>
                                            <a class="btn btn-primary btn-xs" href="PAsocAlumnoGpoEspec.php?cboGrupoEsp=<?echo $id;?>">
                                                <span class="glyphicon glyphicon-plus"></span>
                                            </a>   
                                        </td>
                                        <td>
                                            <a class="btn btn-primary btn-xs" href="PEditarGrupoEspecial.php?id=<?echo $id;?>">
                                                <span class="glyphicon glyphicon-pencil"></span>
                                            </a>
                                        </td>
                                        <td>
                                            <form method="POST" action="common/eliminarGrupoEspecial.php" onsubmit="return confirm('¿Seguro que desea eliminar este grupo especial?');">
