...
$sqlGrupoEspecial = "SELECT * from App_grupos_especiales WHERE id=$idGrupo";
$gpoEspecial = mysqli_query ( $conexion,$sqlGrupoEspecial);
$datoGrupoEspecial = mysqli_fetch_assoc ($gpoEspecial);
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<h4 class="text-primary">Grupo especial: <?=$datoGrupoEspecial["grupo"]?></h4>
  ...
  <tbody class="searchable" style="overflow: auto; max-height: 500px;">
      <?php while ( $dato = mysqli_fetch_assoc ( $datos ) )
    {
      ...
      <tr data-row="<?php echo $dato['id_permiso']?>">
       ...
       <td >
                <a class="btn btn-info btn-xs" href="common/AsociarAlumno.php?idAlumno=<?echo $id;?>">
