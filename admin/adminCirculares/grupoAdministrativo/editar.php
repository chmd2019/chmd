...
ob_start ();
$existe = '';
$datos = mysqli_query ( $conexion,"SELECT id,grupo,descripcion from App_grupos_administrativos WHERE id=".$id);
...
<center>
      <h2>Mantenimiento de grupos administrativos (Editar)</h2>
      <form action="common/actualizarGrupo.php" method="POST">
            ...
            <td><input name="id" id="id" readonly="true" value="<?echo $id?>" /></td>
                ...
                <tr>
                    ...
                    <td><input name="grupo" id="grupo" placeholder="Nombre" value="<?=$grupo?>"></td>
                </tr>

                <tr>
                    <td>Descripci&oacute;n</td>
                    <td><input name="descrip" id="descrip" placeholder="Descripcion" value="<?=$descripcion?>"></td>
                </tr>

                <tr>       
                <td><a href="PGruposAdministrativos.php" class="btn btn-info">Retornar</a></td>
