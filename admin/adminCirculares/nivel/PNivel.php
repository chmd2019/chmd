...
ob_start ();
$existe = '';
$datos = mysqli_query ( $conexion,"SELECT id,nivel from Catalogo_nivel");
...
<!DOCTYPE html>
  ...
  <div class="reload"></div>
    <div class="container" id='principal'>
      ...
      <h2>Mantenimiento de niveles</h2>
   
      <div class="input-group">
        <input type="text" class="form-control" name="q"
            placeholder="Buscar nivel"> <span class="input-group-btn">
    ...
    <br>
    <a class="btn btn-primary btn-xs" href="nuevo.php">
                <span class="glyphicon glyphicon-plus">Nuevo</a>
    <br><br>
    <table class="table" id="niveles_table">
      <thead>
        <td><b>ID</b></td>
        <td><b>Nombre del nivel</b></td>
        <td><b>Acciones</b></td>
      </thead>
