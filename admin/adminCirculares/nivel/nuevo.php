...
<center>
      <h2>Mantenimiento de niveles (Nuevo Nivel)</h2>
      <form action="common/crearNivel.php" method="POST">
            <table class="table table-responsive">
                <tr>
                    <td>Nombre del nivel</td>
                    <td><input name="nnivel" id="nnivel" placeholder="Nombre"></td>
                </tr>
                <tr>       
