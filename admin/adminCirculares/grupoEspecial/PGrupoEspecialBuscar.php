...
$existe = '';
$grupo = $_POST["q"];
$datos = mysqli_query ( $conexion,"SELECT * from App_grupos_especiales WHERE grupo LIKE '%$grupo%'");
...
<!DOCTYPE html>
  ...
  <head>
    ...
    <title>CHMD (Administrador de circulares) :: Grupos Especiales</title>
  ...
  <div class="reload"></div>
    <div class="container" id='principal'>
      ...
      <h2>Mantenimiento de grupos especiales</h2>
    ...
    <a class="btn btn-success btn-xs" href="nuevo.php">
                ...
                <a class="btn btn-info btn-xs" href="PGruposEspeciales.php">
    ...
    <?php while ($dato = mysqli_fetch_assoc ($datos)){
        ...
        <td> <a class="btn btn-success btn-xs" href="asociar.php?id=<?echo $id;?>">
                <span class="glyphicon glyphicon-star"></a></td>
        <td colspan="2">
