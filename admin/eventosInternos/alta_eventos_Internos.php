...
if(isset($_POST['submit']))
{
  ...
  <?php include '../components/header.php'; ?>
    ...
    <a href="PeventosInternos.php" style="cursor: pointer;" class="pull-right">
  <!-- Boton de Atras -->
    ...
    <center>
      <form id="eventos"  name="eventos" class="form-signin save-nivel"   >
        ...
        <div class="modal-footer" style="border:none">
          ...
          <button type="button" class="btn btn-primary" onclick="enviar_formulario(null,6)"><b>ENVIAR</b></button>
        </div>
