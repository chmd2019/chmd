...
if (!in_array('28', $capacidades)){
     header('Location: PHeventosInternosBa.php');
}
...
$datos = mysqli_query ( $conexion,"SELECT  vp.id_permiso,
  ...
  where  vp.tipo_permiso='6' and vp.nfamilia='2'  order by vp.fecha_respuesta DESC" );
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <nav class="" id="sidebar">
      <div id="dismiss">
        ...
        <div class="sidebar-header">
          ...
          <?php $perfil_actual='30'; include ('../menus_dinamicos/perfiles_dinamicos_permisos_internos.php'); ?>
...
<a href="alta_eventos_Internos.php" style="cursor: pointer; margin:2px" class="pull-right"><svg width="120px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
<h2 class="text-primary">Historial de Permisos Internos</h2>
...
<div class="table-responsive-lg">
  ...
  <tbody class="searchable" style="overflow: auto; max-height: 500px;">
    ...
    */
    ...
    if (($fecha_entrada<=$fecha_actual) || $estatus == 3 ) $show=true; else $show=false;
