...
if (!in_array('28', $capacidades)){
     header('Location: PeventosInternosBa.php');
}
...
$datos = mysqli_query ( $conexion,"SELECT  vp.id_permiso,
  ...
  where vp.estatus=2 and vp.tipo_permiso='6' and vp.nfamilia='2'  order by vp.fecha_respuesta DESC" );
?>
...
<a href="alta_eventos_InternosPri.php" style="cursor: pointer; margin:2px" class="pull-right"><svg width="120px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
